...
export const metadata: Metadata = {
  title: "Privacy Policy | 69Swap",
  description: "How 69Swap collects and protects your data. GDPR and CCPA compliant.",
  alternates: { canonical: "https://69swap.com/privacy" },
};
...
const SECTIONS = [
  ...
  { title: "Stripe & Payment Data", body: "Payment processing is handled entirely by Stripe. 69Swap never stores full credit card numbers or banking details. Stripe's privacy policy applies to all payment data. Stripe Connect is used for seller payouts and Stripe's KYC process handles identity verification." },
  ...
  { title: "Your Rights", body: "Depending on your location, you may have rights to access, correct, delete, or port your personal data. EU/UK residents have additional rights under GDPR. California residents have rights under CCPA. Contact privacy@69swap.com to exercise your rights." },
  ...
  { title: "Contact", body: "Privacy inquiries: privacy@69swap.com. Data Protection Officer: dpo@69swap.com." },
];
