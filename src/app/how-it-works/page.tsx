...
export const metadata: Metadata = {
  title: "How It Works — Escrow-Protected Account Trading | 69Swap",
  description: "Learn how 69Swap's Stripe escrow protects buyers and sellers. 7-day inspection period and 4.98-star trust rating.",
  alternates: { canonical: "https://69swap.com/how-it-works" },
};
...
const FAQS = [
  ...
  { q: "What is the platform fee?", a: "69Swap charges buyers a 3% fee on top of the listing price. Listing is free for sellers. No monthly fees." },
      ...
      <section className="bg-gradient-to-b from-indigo-50 to-white border-b border-slate-200">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 py-20 text-center">
          ...
          <h1 className="text-5xl font-extrabold text-slate-900 tracking-tight mb-5">
            How <span className="text-indigo-600">69Swap</span> Works
          </h1>
        ...
        <section className="bg-white rounded-2xl border border-slate-200 p-8">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
            {[
              ...
              { label: "Funds held", icon: "🔒", sub: "Escrow (69Swap)" },
